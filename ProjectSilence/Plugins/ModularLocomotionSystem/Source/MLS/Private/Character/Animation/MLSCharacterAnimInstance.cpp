...
static const FName NAME__MLSCharacterAnimInstance__RotationAmount(TEXT("RotationAmount"));
...
static const FName NAME__MLSCharacterAnimInstance__root(TEXT("root"));


void UMLSCharacterAnimInstance::NativeInitializeAnimation()
{
	Super::NativeInitializeAnimation();
	Character = Cast<AMLSBaseCharacter>(TryGetPawnOwner());
}

void UMLSCharacterAnimInstance::NativeBeginPlay()
{
...
void UMLSCharacterAnimInstance::NativeUpdateAnimation(float DeltaSeconds)
{
...
void UMLSCharacterAnimInstance::PlayTransition(const FDynamicMontageParams& Parameters)
{
...
void UMLSCharacterAnimInstance::PlayTransitionChecked(const FDynamicMontageParams& Parameters)
{
...
void UMLSCharacterAnimInstance::PlayDynamicTransition(float ReTriggerDelay, FDynamicMontageParams Parameters)
{
	if (bCanPlayDynamicTransition)
	{
		...
		World->GetTimerManager().SetTimer(PlayDynamicTransitionTimer, this,
		                                  &UMLSCharacterAnimInstance::PlayDynamicTransitionDelay,
		                                  ReTriggerDelay, false);
	}
}

bool UMLSCharacterAnimInstance::ShouldMoveCheck() const
{
	return (CharacterInformation.bIsMoving && CharacterInformation.bHasMovementInput) ||
		CharacterInformation.Speed > 150.0f;
}

bool UMLSCharacterAnimInstance::CanRotateInPlace() const
{
	return RotationMode.Aiming();
}

bool UMLSCharacterAnimInstance::CanTurnInPlace() const
{
	return RotationMode.LookingDirection() &&
		GetCurveValue(NAME_Enable_Transition) >= 0.99f;
}

bool UMLSCharacterAnimInstance::CanDynamicTransition() const
{
	return GetCurveValue(NAME_Enable_Transition) >= 0.99f;
}

void UMLSCharacterAnimInstance::PlayDynamicTransitionDelay()
{
	bCanPlayDynamicTransition = true;
}

void UMLSCharacterAnimInstance::OnPivotDelay()
{
	Grounded.bPivot = false;
}

void UMLSCharacterAnimInstance::UpdateAimingValues(float DeltaSeconds)
{
...
void UMLSCharacterAnimInstance::UpdateLayerValues()
{
...
void UMLSCharacterAnimInstance::UpdateFootIK(float DeltaSeconds)
{
...
void UMLSCharacterAnimInstance::SetFootLocking(float DeltaSeconds, FName EnableFootIKCurve, FName FootLockCurve,
                                               ...
                                               FVector& CurFootLockLoc, FRotator& CurFootLockRot)
{
	...
	if (UseFootLockCurve)
	{
		UseFootLockCurve = FMath::Abs(GetCurveValue(NAME__MLSCharacterAnimInstance__RotationAmount)) <= 0.001f ||
...
void UMLSCharacterAnimInstance::SetFootLockOffsets(float DeltaSeconds, FVector& LocalLoc, FRotator& LocalRot)
{
...
void UMLSCharacterAnimInstance::SetPelvisIKOffset(float DeltaSeconds, FVector FootOffsetLTarget,
...
void UMLSCharacterAnimInstance::ResetIKOffsets(float DeltaSeconds)
{
...
void UMLSCharacterAnimInstance::SetFootOffsets(float DeltaSeconds, FName EnableFootIKCurve, FName IKFootBone,
...
void UMLSCharacterAnimInstance::RotateInPlaceCheck()
{
...
void UMLSCharacterAnimInstance::TurnInPlaceCheck(float DeltaSeconds)
{
...
void UMLSCharacterAnimInstance::DynamicTransitionCheck()
{
...
void UMLSCharacterAnimInstance::UpdateMovementValues(float DeltaSeconds)
{
...
void UMLSCharacterAnimInstance::UpdateRotationValues()
{
...
float UMLSCharacterAnimInstance::GetAnimCurveClamped(const FName& Name, float Bias, float ClampMin,
                                                     float ClampMax) const
{
	return FMath::Clamp(GetCurveValue(Name) + Bias, ClampMin, ClampMax);
}

FVelocityBlend UMLSCharacterAnimInstance::CalculateVelocityBlend() const
{
...
FVector UMLSCharacterAnimInstance::CalculateRelativeAccelerationAmount() const
{
...
float UMLSCharacterAnimInstance::CalculateStrideBlend() const
{
...
float UMLSCharacterAnimInstance::CalculateWalkRunBlend() const
{
...
float UMLSCharacterAnimInstance::CalculateStandingPlayRate() const
{
...
float UMLSCharacterAnimInstance::CalculateDiagonalScaleAmount() const
{
...
float UMLSCharacterAnimInstance::CalculateCrouchingPlayRate() const
{
...
ECharacterMovementDirection UMLSCharacterAnimInstance::CalculateMovementDirection() const
{
	...
	FRotator Delta = CharacterInformation.Velocity.ToOrientationRotator() - CharacterInformation.AimingRotation;
	Delta.Normalize();
	return UMLSMathLibrary::CalculateQuadrant(MovementDirection, 70.0f, -70.0f, 110.0f, -110.0f, 5.0f, Delta.Yaw);
}

void UMLSCharacterAnimInstance::TurnInPlace(FRotator TargetRotation, float PlayRateScale, float StartTime,
...
void UMLSCharacterAnimInstance::OnPivot()
{
