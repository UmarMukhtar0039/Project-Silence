...
#include "MLSCharacterMovementComponent.generated.h"

/**
 * Authoritative networked Character Movement
 */
UCLASS()
class MLS_API UMLSCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_UCLASS_BODY()

	class MLS_API FSavedMove_My : public FSavedMove_Character
	{
	public:
		...
		ECharacterGait SavedAllowedGait = ECharacterGait::Walking;
	};

	class MLS_API FNetworkPredictionData_Client_My : public FNetworkPredictionData_Client_Character
	{
	public:
	...
	UPROPERTY()
	ECharacterGait AllowedGait = ECharacterGait::Walking;
	...
	UFUNCTION(BlueprintCallable, Category = "Movement Settings")
	void SetAllowedGait(ECharacterGait NewAllowedGait);

	/*UFUNCTION(Reliable, Server, Category = "Movement Settings")
	void Server_SetAllowedGait(ECharacterGait NewAllowedGait);*/
};
