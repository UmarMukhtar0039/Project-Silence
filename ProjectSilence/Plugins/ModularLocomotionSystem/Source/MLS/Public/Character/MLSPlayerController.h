...
#include "MLSPlayerController.generated.h"
...
class MLS_API AMLSPlayerController : public APlayerController
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadOnly, Category = "MLS")
	TObjectPtr<AMLSBaseCharacter> PossessedCharacter = nullptr;

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "MLS|Input")
